      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            /*멀티케이스스탬프*/MultiCaseMaker(text: '멀티케이스스탬프', background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            ...
            /*카톡보고스탬프*/PlanedScheduleManagementHelper(text: "카톡보고스탬프", items: const ['언제쯤 될것같아?', '언제까지 될것같아?', '확인해보고 말씀드리겠습니다', '확인해보겠습니다', '5분에서 10분 정도 걸릴것 같습니다', '15분 정도 걸릴것 같습니다', '30분 정도 걸릴것 같습니다', '1시간 정도 걸릴것 같습니다', '부장님 125번 접속 시도해도 되겠습니까?', '부장님 이거 먼저 처리할까요?', '유지보수 엑셀 업데이트 해두었습니다.\n수고하셨습니다', '넵! 부장님도 잘 쉬십시오\n다음주에 뵙겠습니다!', '네 부장님 오늘도 고생하셨습니다.\n다음주에 뵙겠습니다^^.', '수고하셨습니다', '처리하였습니다', '부장님 처리했습니다']),
            /*주석스탬프*/PlanedScheduleManagementHelper(text: "주석스탬프", items: const ['//DEVELOPMENT', '#DEVELOPMENT', "<!--DEVELOPMENT-->"]),
            /*일회용스탬프*/for (int i = 0; i < 5; i++) DisposalStampMaker(text: '일회용스탬프', background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 5, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            //일회용 스탬프 UI 를 일관성있게 수정하자
            //LOCAL STORAGE CUSTOM STAMP 도 있으면 좋겠다// CASH 데이터를 가져오기 때문에 지워지지 않는 대신 RESET 버튼이 필요.
            /*하드코딩스탬프*/PlanedScheduleManagementHelper(text: "하드코딩스탬프", items: const ["caretELOPMENT", "caretqlwjs@202204^", "caret!0133", "caretistrator", "caretQAZ", "caret", "caretsion", "caretkul", "caretjan", "caretitc", "caretgon", "caretdgi"]),
          ],
        ),
      ),
    );
