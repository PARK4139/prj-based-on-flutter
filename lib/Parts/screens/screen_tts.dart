            ...
            Center(
              child: Column(
                children: [
                  ...
                  TextButton(
                    child: RainbowTextMaker(text: '저를 눌러주세요!', color: Colors.lightBlueAccent.withOpacity(0.9), font_size: 14.0, font_weight: FontWeight.w300, text_decoration: TextDecoration.none, font_family: "NotoSansCJKkr", font_style: FontStyle.normal, text_align: TextAlign.left, isRainbowMode: true),
