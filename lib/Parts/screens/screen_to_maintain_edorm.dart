...
import '../helpers/withv_work_helper.dart';
import '../helpers/data_maintennace_helper.dart';
      ...
      body: Container(
        child: ListView(
          ...
          children: [
            ...
            WithvedormMaintainanceHelper(texts: texts_asterisk, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            WithvedormMaintainanceHelper(texts: texts_op_access, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            const SizedBox(height: 10),
            WithvedormMaintainanceHelper(texts: texts_CODE_TB, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            WithvedormMaintainanceHelper(texts: texts_MEMBER_TB, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            WithvedormMaintainanceHelper(texts: texts_DORM_APPLY_TB, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            WithvedormMaintainanceHelper(texts: texts_ROOM_INFO_TB, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            WithvedormMaintainanceHelper(texts: texts_APPLY_TERM_TB, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            WithvedormMaintainanceHelper(texts: texts_EDU_SCHEDULE_TB, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5)),
            const SizedBox(height: 10),
            WithvedormMaintainanceHelper(texts: texts_dummy_account_preparation, background_color: MyColors.black_background, color: Colors.white38, font_size: 10, font_weight: FontWeight.w200, padding_vertical: 4, padding_horizontal: 4, border_radius: BorderRadius.circular(5))
          ],
        ),
      ),
    );
