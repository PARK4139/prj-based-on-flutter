...
class ScreenPracticeWebview extends StatefulWidget {
  ...
  @override
  State<ScreenPracticeWebview> createState() => _ScreenPracticeWebviewState();
}

class _ScreenPracticeWebviewState extends State<ScreenPracticeWebview> {
  ...
  void initState() {
    ...
    // ScaffoldMessenger.of(context).showSnackBar(const SnackBar(duration: Duration(milliseconds: 1000),content: Text('WebView 제어를 시작합니다.\n잠시만 기다려 주세요')));
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
    ...
    // ScaffoldMessenger.of(context).showSnackBar(const SnackBar(duration: Duration(milliseconds: 1000),content: Text('준비가 완료되었습니다.\n좋은 시간되세요.')));
...
class SampleMenu extends StatelessWidget {
  ...
  Future<void> _onAddToCache(BuildContext context) async {
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Added a test entry to cache.')));
    }
  }
