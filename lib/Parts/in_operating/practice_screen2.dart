...
class _PracticeScreen2State extends State<PracticeScreen2> {
  ...
  void initState() {
    ...
    // ScaffoldMessenger.of(context).showSnackBar(const SnackBar(duration: Duration(seconds: 1),content: Text('WebView 제어를 시작합니다.\n잠시만 기다려 주세요')));
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
    ...
    // ScaffoldMessenger.of(context).showSnackBar(const SnackBar(duration: Duration(seconds: 1),content: Text('준비가 완료되었습니다.\n좋은 시간되세요.')));
