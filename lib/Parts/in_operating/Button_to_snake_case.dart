...
class Button_to_snake_case extends StatefulWidget {
  ...
  @override
  State<Button_to_snake_case> createState() => _Button_to_snake_caseState();
}

class _Button_to_snake_caseState extends State<Button_to_snake_case> {
