...
class _Screen_web_maintennaceState extends State<Screen_web_maintennace> {
  final ment = '해당 스크린에서는 텍스트를 커스텀하기 위한 텍스트를 제공해주는 서비스를 제공합니다 \n\n'
      '＊"" : .';
      ...
      body: Container(
        child: ListView(
          ...
          children: [
            ...
            Center(child: Rainbow_text(text: 'foo', color: Colors.grey.withOpacity(0.9), font_size: 14.0, font_weight: FontWeight.w300, text_decoration: TextDecoration.none, font_family: "NotoSansCJKkr", font_style: FontStyle.normal, text_align: TextAlign.left, isRainbowMode: false)),
            SizedBox(
              height: 10,
            ),
