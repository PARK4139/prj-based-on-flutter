...
//특정 단어를 포함한 줄만 들여쓰기 하는 기능
  ...
  void test_list_string_handling_functions() {
    ...
    List<String> results_removed = MySuperworkers().get_lines_that_removed_about_specific_texts(origin: texts_origin, texts_that_i_want_to_contain: texts_to_remove);
    // print(results_removed.toString());//DEVELOPMENT

    List<String> results_reindented = MySuperworkers().get_texts_that_reindeted_at_specific_text(origin: results_removed, specific_text: texts_to_reindent);
