...
class MultilineWrappingStampMaker extends StatefulWidget {
  String deprecated;
  final Color color;
  ...
  @override
  State<MultilineWrappingStampMaker> createState() => _MultilineWrappingStampMakerState();
}

class _MultilineWrappingStampMakerState extends State<MultilineWrappingStampMaker> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextButton(
        ...
        child: Text(
          "${widget.prefix}${widget.deprecated}${widget.suffix}",
          style: TextStyle(
            color: widget.color,
