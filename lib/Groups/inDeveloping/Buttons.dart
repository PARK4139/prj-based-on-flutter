...
class Button_to_route_as_new_tab extends StatefulWidget {
  final String text;
  final Color? color;
  final FontWeight? font_weight;
  final double? font_size;
  ...
  const Button_to_route_as_new_tab({
    Key? key,
    required this.text,
    required this.background_color,
    required this.color,
  ...
  @override
  State<Button_to_route_as_new_tab> createState() => _Button_to_route_as_new_tabState();
}

class _Button_to_route_as_new_tabState extends State<Button_to_route_as_new_tab> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
