...
void main() {
  ...
  runApp(SampleLocalStorageToggle2());
}

class SampleLocalStorageToggle2 extends StatefulWidget {
  @override
  State<SampleLocalStorageToggle2> createState() => _SampleLocalStorageToggle2State();
}

class _SampleLocalStorageToggle2State extends State<SampleLocalStorageToggle2> {
      ...
      home: Scaffold(
        body: Center(
          child: ElevatedButton(
            child: Text('${isChecked.toString()??'아직 로컬스토리지에서 값을 가져오지 못했습니다.'}'),  // 혹시 ?? 하기 싫으면 futureBuilder 사용하면 되는게 아닌가 싶다.
