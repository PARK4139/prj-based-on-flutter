      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Center(child: Rainbow_text_maker(text: "CHECK LIST", color: Colors.blueAccent /*Colors.grey.withOpacity(0.9)*/, font_size: 8, font_weight: FontWeight.w200, isRainbowMode: true)),
