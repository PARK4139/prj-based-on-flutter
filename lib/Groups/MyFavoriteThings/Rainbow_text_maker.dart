...
//내가 수집한 텍스트들
class Rainbow_text_maker extends StatefulWidget {
  String text;
  final Color? color;
  ...
  @override
  State<Rainbow_text_maker> createState() => _Rainbow_text_makerState();
}

class _Rainbow_text_makerState extends State<Rainbow_text_maker> {
