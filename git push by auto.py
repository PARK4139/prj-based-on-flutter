print("__________________________________________________________ encoding ")
# -*- coding: utf-8 -*-
print("__________________________________________________________ modules ")
...
print("__________________________________________________________ constant")
...
nbsp = ' '
print("__________________________________________________________ function")
...
def all_info():
    print("__________________________________________________________ 현재 pc에 연결된 드라이브 출력 s")
    drives = win32api.GetLogicalDriveStrings()
    drives = drives.split('\000')[:-1]
    print(drives)
    print("__________________________________________________________ 현재 pc에 연결된 드라이브 출력 e")
    print("__________________________________________________________ 현재 디렉토리 위치 s")
    print(os.getcwd())
    print("__________________________________________________________ 현재 디렉토리 위치 e")
    print("__________________________________________________________ 현재 디렉토리 파일의 Modified/Created/Accessed 일자 s")
    ...
    for line in lines:
        try:
            ...
            pass
    print("__________________________________________________________ 현재 디렉토리 파일의 일자 s")
    print("__________________________________________________________ 생성된지 7일 된 모든 확장자 파일 출력 s")
    os.system('forfiles /P "E:\PRJS_PRIVATE\prj_memo\private.bkup" /S /M *.* /D -7 /C "cmd /c @echo @path" ')
    print("__________________________________________________________ 생성된지 7일 된 모든 확장자 파일 출력 e")
    # print("__________________________________________________________ 생성된지 1일 된 zip 확장자의 백업 파일 삭제 s")
    ...
    # print("__________________________________________________________ 생성된지 1일 된 zip 확장자의 백업 파일 삭제 e")
    print("__________________________________________________________ cmd.exe 실행 결과 한번에 출력 s")
    ...
    print(tmp)
    print("__________________________________________________________ cmd.exe 실행 결과 한번에 출력 e")
    print("__________________________________________________________ 현재 디렉토리 파일만 사이즈 출력 s")
    ...
    for line in lines:
        try:
            ...
            pass
    print("__________________________________________________________ 현재 디렉토리 파일만 사이즈 출력 e")
    print("__________________________________________________________ 현재 디렉토리 파일만 사이즈 출력2 s")
    ...
    for line in lines:
        try:
            ...
            pass
    print("__________________________________________________________ 현재 디렉토리 파일만 사이즈 출력2 e")
    print("__________________________________________________________ 현재 디렉토리 파일만 생성일자 출력 s")
    current_files = subprocess.check_output('dir /b /s /o /a-d', shell=True).decode('utf-8')  # 파일만
    lines = current_files.split("\n")
    for line in lines:
        try:
            ...
            pass
    print("__________________________________________________________ 현재 디렉토리 파일만 생성일자 출력 e")
    print("__________________________________________________________ 20230414 18:00 이후 생성된 파일 출력 s")
    ...
    print("__________________________________________________________ 20180526 14:00 이후 생성된 파일 출력 e")
    print("__________________________________________________________ 20230414 18:00 이전 생성된 파일 출력 s")
    inputDate = datetime.strptime(str(input('Searching Input Date : ')), '%Y%m%d %H:%M')
    opening_directory = r'D:\test'
    for (path, dir, files) in os.walk(opening_directory):
        for filename in files:
    ...
    print("__________________________________________________________ 20180526 14:00 이전 생성된 파일 출력 e")
    print("__________________________________________________________ 현재시간기준 생성된지 1일 된 zip 확장자 파일만 출력 s")
    ...
    for (path, dir, files) in os.walk(opening_directory):
        for filename in files:
            ...
            if inputDate < fileMtime:
                ...
                print('[%s]' % (filename))
    pause()
    print("__________________________________________________________ 현재시간기준 생성된지 1일 된 zip 확장자 파일만 출력 e")
    print("__________________________________________________________ __________.xls s")
    print("__________________________________________________________ __________.xls e")
    print("__________________________________________________________ __________.json writing s")
    import json
    data_as_dict = {
        'ID_REQUEST': 1,
    ...
    print("__________________________________________________________ __________.json writing e")
    print("__________________________________________________________ __________.json JSON Encoding s")
    data_as_dict = {
        'ID_REQUEST': 1,
        'CUSTOMER_NAME': '_박_정_훈_',
        'MASSAGE_REQUESTED': '주문서변경요청',
    ...
    with open(json_file_path, 'w') as outfile:
        json.dump(data_as_dict, outfile, indent=4)
    print("__________________________________________________________ __________.json JSON Encoding e")
    print("__________________________________________________________ __________.json JSON Decoding s")
    ...
    print("__________________________________________________________ __________.json JSON Decoding e")
    print("__________________________________________________________ __________.json e")
    print("__________________________________________________________ __________.yaml s")
    ...
    print(__________1)
    print(__________2)
    print("__________________________________________________________ __________.yaml e")
    print("__________________________________________________________ doctest s")
    import doctest
    def ipconfig():
        """
    ...
    doctest.testmod()
    print("__________________________________________________________ doctest e")
    print("__________________________________________________________ pytest s")
    print("__________________________________________________________ pytest e")
    print("__________________________________________________________ data test s")
    ...
    def checkData(__________):
        ...
        if type(__________) == 'String':
            ...
            print(None)
    print("__________________________________________________________ data test e")
    print("__________________________________________________________ f 문자열 포매팅 s")
    ...
    print("__________________________________________________________ f 문자열 포매팅 e")
    print("__________________________________________________________ 데이터의 정렬 s")
    ...
    print(od)
    print("__________________________________________________________ 데이터의 정렬 e")
...
def AI_respon(usr_input_txt):
    if usr_input_txt == 'pass':
        ...
        try:
            print("__________________________________________________________ 미세먼지] ")
        ...
        try:
            print("__________________________________________________________ 근태관리] ")
            INFO_NAME = '미세먼지랭킹 미세먼지 정보'
        ...
        print("__________________________________________________________ 전체페이지 출력 시도] ")
        AI_print(page.text.split('\n'))

        print("__________________________________________________________ 기온] ")
        copied_html_selector = '#main_pack > section.sc_new.cs_weather_new._cs_weather > div._tab_flicking > div.content_wrap > div.open > div:nth-child(1) > div > div.weather_info > div > div._today > div.temperature_info > dl > dd:nth-child(2)'
        elements = soup.select(copied_html_selector)
        ...
        AI_speak('도')
        print("__________________________________________________________ 현재온도] ")
        ...
        AI_speak('도')
        print("__________________________________________________________ 체감온도] ")
        copied_html_selector = '#main_pack > section.sc_new.cs_weather_new._cs_weather > div._tab_flicking > div.content_wrap > div.open > div:nth-child(1) > div > div.weather_info > div > div._today > div.temperature_info > dl > dd:nth-child(2)'
        elements = soup.select(copied_html_selector)
        for index, element in enumerate(elements, 1):
            # print("{} 번째 text: {}".format(index, element.text))
        ...
        AI_speak(element_str.replace('°', ''))
        AI_speak('도')
        print("__________________________________________________________ 습도] ")
        ...
        AI_speak(element_str.replace('%', ''))
        AI_speak('퍼센트')
        print("__________________________________________________________ 바람] ")
        ...
        AI_speak('미터퍼세크')
        print("__________________________________________________________ 자외선] ")
        ...
        AI_speak('미세먼지')
        AI_speak(element_str.strip().replace('m/s', ''))
        print("__________________________________________________________ 초미세먼지] ")
        ...
        # print("__________________________________________________________ _________] ")
        # copied_html_selector = '_________'
        # elements = soup.select(copied_html_selector)
        # AI_print(elements)#추출된 elements 출력 시도

    elif usr_input_txt == 'hardcode json 처리':
        print("__________________________________________________________ json 처리 시작] ")
        INFO_NAME = '네이버 체감온도 정보'
        dataWebLocation = 'https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=%EA%B8%B0%EC%98%A8'
        copied_html_selector = '#main_pack > section.sc_new.cs_weather_new._cs_weather > div._tab_flicking > div.content_wrap > div.open > div:nth-child(1) > div > div.weather_info > div > div._today > div.temperature_info > dl > dd:nth-child(2)'
...
def pause():
    try:
        print("__________________________________________________________ code debugging")
        os.system("chcp 65001")
        os.system("pause")
    except Exception as e:
...
def mkr_s():
    print("__________________________________________________________ mkr s")
...
print("__________________________________________________________ opening log s")
time_s = time.time()
print(to_time_style('0'))
print("__________________________________________________________ opening log e")
...
print("__________________________________________________________ ending log s")
time_e = time.time()
print(to_time_style('0'))
print(time_e - time_s)
print("__________________________________________________________ ending log e")